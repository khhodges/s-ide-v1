...
-   **mSave — Write Gate**: Every write to a c-list goes through mSave for source GT validation: version match, seal valid, B=1 (bindable), and F=0 on target slot (not frozen). Symmetric counterpart to mLoad in the TSB.
